...
#   Purpose : plotting choropleth Plot017
#   Date    : 18-JAN-2019  
...
file_column_name <- "AuslaenderAnteilRank"
...
ggplot() +
  labs(
    title="Gemeinderanking LU nach Merkmal Ausländeranteil",
    subtitle="Plot 17: Ranks 1-83, basierend auf BFS",
    x=NULL,
    y=NULL) +
  geom_map (
    data = gd_dat,
...
ggsave(
  filename = "Plot017_Gemeinden_AuslaenderAnteilRank.png",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1,
  dpi = 600)
...
ggsave(
  filename = "Plot017_Gemeinden_AuslaenderAnteilRank.svg",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1)
