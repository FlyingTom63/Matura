...
#   Purpose : plotting choropleth Plot004
#   Date    : 18-JAN-2019  
...
file_column_name <- "ArbeitsmarktRank"
...
ggplot() +
  labs(
    title="Gemeinderanking LU nach Merkmal Arbeitsmarkt",
    subtitle="Plot 4: Ranks 1-83, basierend auf CH-Ranking, Missing Values gemäss Nachbarschaft",
    x=NULL,
    y=NULL) +
  geom_map (
    data = gd_dat,
...
ggsave(
  filename = "Plot004_Gemeinden_ArbeitsmarktRank.png",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1,
  dpi = 600)
...
ggsave(
  filename = "Plot004_Gemeinden_ArbeitsmarktRank.svg",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1)
