...
#   Purpose : plotting choropleth Plot007
#   Date    : 18-JAN-2019  
...
file_column_name <- "VersorgungRank"
...
ggplot() +
  labs(
    title="Gemeinderanking LU nach Merkmal Versorgung",
    subtitle="Plot 7: Ranks 1-83, basierend auf CH-Ranking, Missing Values gemäss Nachbarschaft",
    x=NULL,
    y=NULL) +
  geom_map (
    data = gd_dat,
...
ggsave(
  filename = "Plot007_Gemeinden_VersorgungRank.png",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1,
  dpi = 600)
...
ggsave(
  filename = "Plot007_Gemeinden_VersorgungRank.svg",
  plot = last_plot(),
  path = "images/Plots",
  scale = 1)
